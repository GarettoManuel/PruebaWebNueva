...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "PruebaWebNueva.Maui.dll" comes first in this list. */
		"PruebaWebNueva.Maui.dll",
		"BCrypt.Net-Next.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"PruebaWebNueva.Application.dll",
		"PruebaWebNueva.Client.SharedUI.dll",
		"PruebaWebNueva.Domain.dll",
		"PruebaWebNueva.Infrastructure.dll",
