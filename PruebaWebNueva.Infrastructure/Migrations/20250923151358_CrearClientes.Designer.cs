...
namespace PruebaWebNueva.Infrastructure.Migrations
{
    ...
    [Migration("20250923151358_CrearClientes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PruebaWebNueva.Domain.Entities.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PruebaWebNueva.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2025, 9, 23, 12, 13, 58, 387, DateTimeKind.Local).AddTicks(5723),
                            NombreCompleto = "Administrador del Sistema",
                            NombreUsuario = "administrador",
                            PasswordHash = "$2a$11$yvgFPaj3uO7TroG1zBse6Ome3IBBtAHlCxd1Nyz59jiPVQzEVjfqS"
                        });
                });
            ...
            modelBuilder.Entity("PruebaWebNueva.Domain.Entities.UsuarioPermiso", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            FechaAsignacion = new DateTime(2025, 9, 23, 12, 13, 58, 387, DateTimeKind.Local).AddTicks(6324),
                            PermisoId = 1,
                            UsuarioId = 1
                        },
                        new
                        {
                            Id = 2,
                            FechaAsignacion = new DateTime(2025, 9, 23, 12, 13, 58, 387, DateTimeKind.Local).AddTicks(6328),
                            PermisoId = 2,
                            UsuarioId = 1
                        },
                        new
                        {
                            Id = 3,
                            FechaAsignacion = new DateTime(2025, 9, 23, 12, 13, 58, 387, DateTimeKind.Local).AddTicks(6329),
                            PermisoId = 3,
                            UsuarioId = 1
                        },
                        new
                        {
                            Id = 4,
                            FechaAsignacion = new DateTime(2025, 9, 23, 12, 13, 58, 387, DateTimeKind.Local).AddTicks(6331),
                            PermisoId = 4,
                            UsuarioId = 1
                        },
                        new
                        {
                            Id = 5,
                            FechaAsignacion = new DateTime(2025, 9, 23, 12, 13, 58, 387, DateTimeKind.Local).AddTicks(6332),
                            PermisoId = 5,
                            UsuarioId = 1
                        },
                        new
                        {
                            Id = 6,
                            FechaAsignacion = new DateTime(2025, 9, 23, 12, 13, 58, 387, DateTimeKind.Local).AddTicks(6334),
                            PermisoId = 6,
                            UsuarioId = 1
                        },
                        new
                        {
                            Id = 7,
                            FechaAsignacion = new DateTime(2025, 9, 23, 12, 13, 58, 387, DateTimeKind.Local).AddTicks(6336),
                            PermisoId = 7,
                            UsuarioId = 1
                        },
                        new
                        {
                            Id = 8,
                            FechaAsignacion = new DateTime(2025, 9, 23, 12, 13, 58, 387, DateTimeKind.Local).AddTicks(6337),
                            PermisoId = 8,
                            UsuarioId = 1
                        },
                        new
                        {
                            Id = 9,
                            FechaAsignacion = new DateTime(2025, 9, 23, 12, 13, 58, 387, DateTimeKind.Local).AddTicks(6338),
                            PermisoId = 9,
                            UsuarioId = 1
                        },
                        new
                        {
                            Id = 10,
                            FechaAsignacion = new DateTime(2025, 9, 23, 12, 13, 58, 387, DateTimeKind.Local).AddTicks(6339),
                            PermisoId = 10,
                            UsuarioId = 1
                        },
                        new
                        {
                            Id = 11,
                            FechaAsignacion = new DateTime(2025, 9, 23, 12, 13, 58, 387, DateTimeKind.Local).AddTicks(6340),
                            PermisoId = 11,
                            UsuarioId = 1
                        });
                });
